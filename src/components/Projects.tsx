...
const projects = [
  ...
  { number: '03', name: 'Escrow BD', url: 'https://escrowbd.com', category: 'Fintech / Security', description: 'A secure escrow service for online transactions in Bangladesh, protecting both buyers and sellers during high-value exchanges.', tech: ['PHP', 'MySQL', 'Payment Gateway', 'Security'], status: 'Live' },
  { number: '04', name: 'Saddam Store', url: 'https://saddamstore.com', category: 'Retail E-Commerce', description: 'A retail e-commerce site focused on scalability and performance, built to handle high traffic and large product catalogs.', tech: ['WordPress', 'WooCommerce', 'MySQL', 'SEO'], status: 'Live' },
  { number: '05', name: 'CJ Computer BD', url: 'https://cjcomputerbd.com', category: 'Tech E-Commerce', description: 'A technology-focused e-commerce site for computer hardware and accessories with a clean product catalog and order management.', tech: ['PHP', 'MySQL', 'UI/UX', 'E-Commerce'], status: 'Live' },
  { number: '06', name: '35 Taka Course', url: 'https://35takacource.xyz', category: 'EdTech Platform', description: 'An affordable online course platform with secure payment options, making quality education accessible for everyone in Bangladesh.', tech: ['PHP', 'Laravel', 'MySQL', 'Payment Gateway'], status: 'Live' },
